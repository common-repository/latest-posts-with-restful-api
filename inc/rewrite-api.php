...
function lpra_get_posts_feed_restapi()
{
    ...
    if (!empty($allcontent))
    {
        ...
        if(!term_exists( 'mobile_app_more', 'category' ))
            wp_create_category('mobile_app_more');
        ...
        $response1 = wp_get_recent_posts(array(
            'numberposts' => ($allcontent!='') ? $allcontent : '30', // Number of recent posts thumbnails to display
